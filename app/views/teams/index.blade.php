...
@section('content')
	...
	@foreach ($teams as $team)
    	<tr>
			...
			<td>{{ Form::open( array('url' => "teams/$team->id", 'method' => 'DELETE')) }}<button type="Submit" value="submit" class="btn btn-danger"><i class="icon-white icon-trash"></i></button>{{ Form::close()}}</td>
			@endif
		</tr>
	@endforeach
	</table>
