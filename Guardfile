guard :concat, :type => "css", :files => %w[bootstrap bootstrap-responsive font-awesome style jquery.fancybox prettyPhoto responsive royalslider rs-default-inverted slicebox], :input_dir => "public/css", :output => "public/css/styles.min"

guard :concat, :type => "js", :files => %w[superfish jquery.royalslider jquery.fancybox jquery.slicebox jquery.tweet modernizr.custom.46884 bootstrap-datepicker], :input_dir => "public/js", :output => "public/js/scripts.min"
